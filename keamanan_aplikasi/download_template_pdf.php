...
$pdf->addText(40, 790, "TEMPLATE IMPORT TRANSAKSI - DOMPETKU", 16, true, [25, 135, 84]);
$pdf->addText(40, 775, "Gunakan tabel di bawah ini sebagai acuan pengisian data transaksi", 10, false, [100, 100, 100]);

// Garis pembatas header
$pdf->addLine(40, 765, 550, 765, [25, 135, 84], 2.0);

// 2. Informasi Laporan
$pdf->addText(40, 745, "Dokumen ini adalah template resmi untuk fitur Impor PDF DompetKu.", 10, true, [80, 80, 80]);
$pdf->addText(40, 730, "Panduan: Importer PDF kami membaca baris data di dalam tabel secara sekuensial.", 9, false, [120, 120, 120]);
...
$pdf->addText(50, $y_row - 28, "1. Format Tanggal wajib YYYY-MM-DD (contoh: 2026-06-25).", 9, false, [100, 100, 100]);
$pdf->addText(50, $y_row - 41, "2. Jenis harus diisi 'Pemasukan' atau 'Pengeluaran'. Nominal harus berupa angka murni.", 9, false, [100, 100, 100]);
